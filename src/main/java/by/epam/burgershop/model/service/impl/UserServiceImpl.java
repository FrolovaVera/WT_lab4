...
import by.epam.burgershop.model.util.PasswordEncoder;
...
import static by.epam.burgershop.controller.command.RequestParameter.*;
...
public class UserServiceImpl implements UserService {
    ...
    private static final String HEADER_FOR_VERIFICATION_CUSTOMER = "Activation from Burgershop";
    private static final String MESSAGE_FOR_VERIFICATION_CUSTOMER = """
            Hello, %s  %s welcome to Burgershop. Your activation code is %s
            """;
