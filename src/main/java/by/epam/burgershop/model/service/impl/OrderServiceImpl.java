package by.epam.burgershop.model.service.impl;
...
import by.epam.burgershop.model.dao.OrderDao;
import by.epam.burgershop.model.dao.RestaurantDao;
import by.epam.burgershop.model.dao.UserDao;
import by.epam.burgershop.model.dao.impl.OrderDaoImpl;
import by.epam.burgershop.model.dao.impl.RestaurantDaoImpl;
import by.epam.burgershop.model.dao.impl.UserDaoImpl;
import by.epam.burgershop.model.service.OrderService;
import by.epam.burgershop.model.verification.EmailSending;
import by.epam.burgershop.model.verification.impl.EmailSendingImpl;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public List<Order> findAllProcessingOrdersForRestaurants(String restaurantId) throws ServiceException {
        long id = Long.parseLong(restaurantId);
        List<Order> orders;
        OrderDao orderDao = OrderDaoImpl.getInstance();
        try {
         orders = orderDao.findAllProcessingOrdersForRestaurants(id);
        } catch (DaoException e) {
            logger.log(Level.ERROR, "DaoException is in method findAllProcessingOrdersForRestaurants() ", e);
            throw new ServiceException("DaoException is in method findAllProcessingOrdersForRestaurants() ", e);
        }
        return orders;
    }
