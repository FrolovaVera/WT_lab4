...
import by.epam.burgershop.model.dao.ColumnName;
...
import static by.epam.burgershop.model.dao.ColumnName.*;
...
public class OrderDaoImpl implements OrderDao {
    ...
    @Override
    public List<Order> findAllProcessingOrdersForRestaurants(long restaurantId) throws DaoException {
        ...
        try (Connection connection = connectionPool.getConnection();
            ...
            logger.log(Level.ERROR, "SQLException in method findAllProcessingOrdersForRestaurants() ", e);
            throw new DaoException("SQLException in method findAllProcessingOrdersForRestaurants() ", e);
        }
        return orders;
    }
