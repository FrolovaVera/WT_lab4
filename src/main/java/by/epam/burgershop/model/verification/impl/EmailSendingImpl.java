package by.epam.burgershop.model.verification.impl;

import by.epam.burgershop.entity.User;
import by.epam.burgershop.model.verification.EmailSending;
import by.epam.burgershop.model.verification.MailSender;
...
public class EmailSendingImpl implements EmailSending {
    ...
    public void sendEmail(User user, String codeOrOrderNumber, String header, String message) {
        ...
        try {
            ...
            //TODO
            properties.load(new FileReader("D://Intelij Ultimate Project//WEBProjectEpam//EPAMFinal//epam-online-burgershop//src//main//resources//prop//mail.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
