...
/**
 * The type Go to updating restaurant city page command.
 */
public class GoToUpdatingRestaurantCityPageCommand implements Command {
    @Override
    public CommandResult execute(HttpServletRequest request) {
        ...
        return new CommandResult(PagePath.UPDATING_RESTAURANT_CITY, CommandResult.RoutingType.REDIRECT);
    }
}
