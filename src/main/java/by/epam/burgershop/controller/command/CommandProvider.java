...
import by.epam.burgershop.controller.command.impl.*;
import by.epam.burgershop.controller.command.impl.admin.*;
import by.epam.burgershop.controller.command.impl.customer.SendingOrderCommand;
import by.epam.burgershop.controller.command.impl.customer.*;
import by.epam.burgershop.controller.command.impl.manager.*;
...
public class CommandProvider {
    ...
    private CommandProvider() {
        ...
        commands.put(CommandType.ALL_RESTAURANTS, new AllRestaurantsCommand());
