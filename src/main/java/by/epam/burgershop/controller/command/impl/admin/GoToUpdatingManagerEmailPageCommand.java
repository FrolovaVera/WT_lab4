...
/**
 * The type Go to updating manager email page command.
 */
public class GoToUpdatingManagerEmailPageCommand implements Command {
    @Override
    public CommandResult execute(HttpServletRequest request) {
        ...
        return new CommandResult(PagePath.UPDATING_MANAGER_EMAIL, CommandResult.RoutingType.REDIRECT);
    }
}
