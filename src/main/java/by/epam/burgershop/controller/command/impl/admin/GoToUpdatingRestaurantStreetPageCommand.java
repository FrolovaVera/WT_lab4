...
/**
 * The type Go to updating restaurant street page command.
 */
public class GoToUpdatingRestaurantStreetPageCommand implements Command {
    @Override
    public CommandResult execute(HttpServletRequest request) {
        ...
        return new CommandResult(PagePath.UPDATING_RESTAURANT_STREET, CommandResult.RoutingType.REDIRECT);
    }
}
