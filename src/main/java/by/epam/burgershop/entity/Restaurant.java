package by.epam.burgershop.entity;
...
public class Restaurant {
     ...
     */
    public Restaurant(long restaurantId, int number, String city, String street, String house, Integer block) {
    ...
    public static class Builder {
         ...
         * @return the restaurant id
         */
        public Restaurant.Builder setRestaurantId(long restaurantId) {
         ...
         * @return the number
         */
        public Restaurant.Builder setNumber(int number) {
         ...
         * @return the city
         */
        public Restaurant.Builder setCity(String city) {
         ...
         * @return the street
         */
        public Restaurant.Builder setStreet(String street) {
         ...
         * @return the house
         */
        public Restaurant.Builder setHouse(String house) {
         ...
         * @return the block
         */
        public Restaurant.Builder setBlock(Integer block) {
